...
const VotingStatusModal = ({ className, visible, onCancel, title, operationStatus, txHash, proposalChanger, votingInFavor, showProposal }) => {
            ...
            <div className="proposal-container">
                ...
                {showProposal && (
                    <div className="proposal">
                        <div className='proposal-changer'>
                            <div className='proposal-changer-label'>
                                Proposal Changer:
                            </div>
                            <div className='proposal-changer-value'>
                                <CopyAddress address={proposalChanger} type={'tx'}></CopyAddress>
                            </div>
                        </div>

                        <div className='proposal-vote-infavor'>
                            {votingInFavor && (
                                <div className='proposal-vote-infavor-label'>
                                    You are voting in favor!
                                </div>
                            )}

                            {!votingInFavor && (
                                <div className='proposal-vote-against-label'>
