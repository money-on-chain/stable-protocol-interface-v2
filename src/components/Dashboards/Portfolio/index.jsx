...
export default function Portfolio() {
    ...
    // Tokens CA
    auth.contractStatusData && auth.userBalanceData && settings.tokens.CA.forEach(function(dataItem) {
    ...
    // Tokens TP
    auth.contractStatusData && auth.userBalanceData && settings.tokens.TP.forEach(function(dataItem) {
        balance = new BigNumber(fromContractPrecisionDecimals(auth.userBalanceData.TP[dataItem.key],
            settings.tokens.TP[dataItem.key].decimals))
        price = new BigNumber(fromContractPrecisionDecimals(auth.contractStatusData.PP_TP[dataItem.key],
            settings.tokens.TP[dataItem.key].decimals))
