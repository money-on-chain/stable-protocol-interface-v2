...
export default function ConfirmSend(props) {
    ...
    switch (status) {
        case 'SUBMIT':
            ...
            statusLabel = t('send.confirm.submit');
            break;
        case 'SIGN':
            sentIcon = 'icon-signifier';
            statusLabel = t('send.confirm.sign');
            break;
        case 'WAITING':
            sentIcon = 'icon-tx-waiting rotate';
            statusLabel = t('send.confirm.waiting');
            break;
        case 'SUCCESS':
            sentIcon = 'icon-tx-success';
            statusLabel = t('send.confirm.success');
            break;
        case 'ERROR':
            sentIcon = 'icon-tx-error';
            statusLabel = t('send.confirm.error');
            break;
        default:
            sentIcon = 'icon-tx-waiting rotate';
            statusLabel = t('send.confirm.default');
    }
